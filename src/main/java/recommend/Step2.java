...
class Step2 {
    static void run(Map<String, String> path) throws IOException {
        ...
        conf.setCombinerClass(Step2UserVectorToCooccurrenceReducer.class);
        conf.setReducerClass(Step2UserVectorToCooccurrenceReducer.class);
    ...
    public static class Step2UserVectorToCooccurrenceReducer extends MapReduceBase implements Reducer<Text, IntWritable, Text, IntWritable> {
